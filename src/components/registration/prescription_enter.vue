...
<template>
  <div id="item" class="content">
    ...
    <div class="d-flex" id="title">
      <div class="text-h2">Kickstart your Journey</div>
    </div>

    <div id="description">
      YOUR PARTNERING DOCTOR HAS GIVEN YOU AN INVITE CODE TO USE WITH FINN.
      <br /><br />
      <div class="d-flex justify-center">
        <v-form class="w-75" @submit.prevent>
          <v-text-field
            v-model="Code"
            :rules="rules"
            label="Enter your prescription code"></v-text-field>
        </v-form>
      </div>
    </div>
  </div>
